...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'points', name: 'PointsMall', component: () => import('@/views/points/index.vue'), meta: { title: '积分兑奖' } },
        // 问答管理
  ...
  { path: 'finance', name: 'Finance', component: () => import('@/views/finance/index.vue'), meta: { title: '财务总览' } },
        ...
        { path: 'finance/refund', redirect: () => ({ path: '/v2/refunds' }) },
        ...
        { path: 'refund', redirect: () => ({ path: '/v2/refunds' }) },
